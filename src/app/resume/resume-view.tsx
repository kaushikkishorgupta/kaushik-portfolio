...
// Drop the compiled PDF here: frontend/public/Kaushik_Kishor_Gupta_Resume.pdf
const RESUME_PATH = "/Kaushik_Kishor_Gupta_Resume.pdf";
      ...
      <div className="mx-auto flex w-full max-w-4xl flex-1 items-center justify-center px-2 pb-6 md:items-start md:px-4 md:pb-24">
        ...
        >
          <ResumeDoodle
            ...
            title="Kaushik Kishor Gupta — Resume"
          />
        </motion.div>
      </div>
    </div>
